...
export default function EditEvents() {
  ...
  const getData = async () => {
    ...
    if (eventDoc.exists()) {
      ...
      setPreviousImage(eventData.image);
    } else {
  ...
  const saveData = async () => {
    try {
      ...
      let productRef = doc(db, "Events", id);
      await updateDoc(productRef, data);
      toast.success("Data updated");
      nav("/senior/manageevent");
    } catch (err) {
              ...
              <form className="form_area" id="myForm" onSubmit={handleAddEvent}>
                <div className="row">
                  <div className="col-lg-12 form_group">
                    ...
                    <label htmlFor="title" className="label-left">
                      Title
                    </label>
                    <input
                      type="text"
                    ...
                    <label htmlFor="mode" className="label-left">
                      Event Mode
                    </label>
                    <input
                      type="text"
                    ...
                    <label htmlFor="venue" className="label-left">
                      Venue
                    </label>
                    <input
                      type="text"
